...
//        try {
//            String path = (String) loader.load("module.package.path", resource).get(0).getProperty("module.package.path");
//            System.out.println(path);
//        } catch (IOException e) {
//            e.printStackTrace();
//        }

        System.out.println(PropertyUtil.load("module.package.path","application.properties"));
